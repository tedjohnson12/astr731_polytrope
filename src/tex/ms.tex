...
\begin{figure}[h]
    \script{res_xi1.py}
    \begin{centering}
        \includegraphics[width=0.5\textwidth]{figures/res_xi1.pdf}
...
\begin{figure}[h]
    ...
    \begin{centering}
        \includegraphics[width=0.5\textwidth]{figures/res_thetaprime.pdf}
...
\begin{figure}[h]
    \script{res_rho.py}
    \begin{centering}
        \includegraphics[width=0.5\textwidth]{figures/res_rho.pdf}
        \caption{Same as Figure \ref{fig:res_xi1}, but for
        $\rho_c/<\rho>$.}
        \label{fig:res_rho}
    \end{centering}
